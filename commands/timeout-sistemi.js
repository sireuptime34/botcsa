...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (timeoutSistemi && timeoutSistemiDate) {
            ...
            .setDescription(`<:carpi:1117083838590492772> | Bu sistem <t:${parseInt(timeoutSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1117083842264703016> | __**Timeout Sistemi**__ başarıyla ayarlandı! __/timeout__ komutu ile sistemi kullanabilirsin.\n\n<:kanal:1040649841996464139> Log Kanalı: ${kanal}\n<:Bot:1106994122344104067> Yetkili Rolü: ${rol}`)
