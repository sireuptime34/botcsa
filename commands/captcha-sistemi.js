...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (rcaptchaSystem && rcaptchaDate) {
            ...
            .setDescription(`<:carpi:1117083838590492772> | Bu sistem <t:${parseInt(rcaptchaDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1117083842264703016> | __**Captcha Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Captcha Kanalı: ${kanal}\n<:Bot:1106994122344104067> Captcha Rolü: ${rol}`)
