...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Sunucu sahibini susturamazsın, nasıl kaldıracaksın?")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Kendi timeoutunu kaldıramazsın, zaten yok.")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Benim susturmam yok ki? Susturamazsında zaten :call_me:")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik:1117083842264703016> | Bir Üye'nin Susturması Kaldırıldı!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1117083842264703016> | ${kullanıcı} adlı üyenin susturmasını kaldırdım.`)
