...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const yetki = new Discord.EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Bu komutu kullanabilmek için `Yönetici` yetkisine sahip olmalısın!")
        ...
        if (ticketSystem && ticketSystemDate) {
            ...
            .setDescription(`<:carpi:1117083838590492772> | Bu sistem <t:${parseInt(ticketSystemDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1117083842264703016> | __**Destek Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Destek Kanalı: ${ticketkanal}\n<:kanal:1040649841996464139> Log Kanalı: ${logkanal}\n<:Bot:1106994122344104067> Yetkili Rolü: ${rol}`)
            ...
            .setColor("000000")
            .setTitle("<:edit:1117124140290297896> | Destek talebi nasıl açabilirim?")
