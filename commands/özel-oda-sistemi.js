...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if (ozelOdaSystem && ozelOdaSystemDate) {
        ...
        .setDescription(`<:carpi:1117083838590492772> | Bu sistem <t:${parseInt(ozelOdaSystemDate.date / 1000)}:R> önce açılmış!`)
  ...
  const channel = await interaction.guild.channels.create({
    ...
    interaction.reply("<:tik:1117083842264703016> | Sesli Kanal Başarıyla Oluşturuldu.")
}
