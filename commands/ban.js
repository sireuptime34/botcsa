...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if(user.permissions.has(PermissionsBitField.Flags.BanMembers)) return interaction.reply({content:"<:carpi:1117083838590492772> | Bu Kullanıcının Ban Yetkisi Olduğu İçin Onu Yasaklayamadım.   ",ephemeral:true})
    user.ban({reason: sebep});
    interaction.reply({content: "<:tik:1117083842264703016> | Başarıyla Üyeyi Yasakladım!"})
}
