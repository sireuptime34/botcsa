...
name: Discord.Events.InteractionCreate,
    ...
    readdirSync('./commands').forEach(f => {
      ...
      if(interaction.commandName.toLowerCase() === cmd.name.toLowerCase()) {
        ...
        if(!rulesisread) {
          ...
          .setTitle("> <:uyari:1040649846400499712>・Kuralları kabul etmek için **Kabul Ediyorum.** butonuna tıklayın!\n> <:yldz:1099361846475116544>・Ama bunu yapmadan önce bi linklere göz atmanı isterim!")
          .setDescription("\n\n**<:Link:1106969829795172514> Linkler**\n> <:Belge:1106969838112477204>・**Botun kullanım koşulları: [Tıkla](https://github.com/araschain/Aries-Bot-Terms-Of-Service)**\n> <:Kilit:1106969826808836176>・**Botun gizlilik politikası: [Tıkla](https://github.com/araschain/Aries-Bot-Privacy-Policy)**")
          .setColor('Blue')
  ...
  .setEmoji("<:tik:1117083842264703016>")
  .setDisabled(true)
  .setCustomId("ooeoeo"))
      const embed = new EmbedBuilder()
  ...
  if(interaction.isModalSubmit()) {
    if (interaction.customId === 'kayitform') {
     ...
     if (interaction.customId === 'form') {
      ...
      if (!onay) interaction.reply({ content: "<:carpi:1117083838590492772> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!logg) interaction.reply({ content: "<:carpi:1117083838590492772> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botRol) interaction.reply({ content: "<:carpi:1117083838590492772> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!devRol) interaction.reply({ content: "<:carpi:1117083838590492772> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!adminRol) interaction.reply({ content: "<:carpi:1117083838590492772> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!botekle) interaction.reply({ content: "<:carpi:1117083838590492772> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      if (!ayrildiLog) interaction.reply({ content: "<:carpi:1117083838590492772> | Botlist sistemi ayarlanmamış!", ephemeral: true })
      ...
      const gonderildi = new EmbedBuilder()
          .setTitle("<:tik:1117083842264703016> | Başarılı!")
      ...
      oda.permissionOverwrites.create(
        ...
        interaction.reply("<:tik:1117083842264703016> | <@"+id+"> Adlı Kullanıcı Odadan Başarıyla Atıldı")
      } else {
    }
    ...
    oda.permissionOverwrites.create(
      ...
      interaction.reply("<:tik:1117083842264703016> | <@"+id+"> Adlı Kullanıcı Odaya Eklendi")
    } else {
  }
 ...
 .addComponents(
  ...
  interaction.reply({ content: `<:tik:1117083842264703016> **|** Senin için bir tane destek kanalı ${channel} oluşturldu.`, ephemeral: true })
...
if(interaction.customId === 'giriscikis'){
  ...
  if (sayacmessage && sayacmessageDate) {
      ...
      .setDescription(`<:carpi:1117083838590492772> | Bu sistem <t:${parseInt(sayacmessageDate.date / 1000)}:R> önce açılmış!`)
  ...
  .setDescription("<:tik:1117083842264703016> **|** Giriş çıkış mesajı aktif edildi!")
  .addFields([
    {
  ...
  return interaction.update({ embeds: [embed], components: [row1] })
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      interaction.reply({content: "<:tik:1117083842264703016> | Rol Başarıyla Verildi!", ephemeral: true})
       } else {
         
        interaction.member.roles.remove(butonrol)
      interaction.reply({content: "<:carpi:1117083838590492772> | Rol Başarıyla Alındı!", ephemeral: true})
    }
      }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:mod:1039607060775571476> | Aries - Moderasyon Menüsü!")
          .addFields(
        { name: "**> <:slash:1041998751419605004> </ban-list:1039964202003079243>**", value: `> <:edit:1117124140290297896> **Banlı kullanıcıları gösterir!**`, inline: true },
        { name: "**> <:slash:1041998751419605004> </ban:1039964202003079244>**", value: `> <:edit:1117124140290297896> **Bir üyeyi yasaklarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </emojiler:1039964202003079250>**", value: `> <:edit:1117124140290297896> **Emojileri gösterir!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </forceban:1039964202045030420>**", value: `> <:edit:1117124140290297896> **ID ile kullanıcı banlarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </giriş-çıkış:1039964202045030424> | </giriş-çıkış-kapat:1039964202045030423>**", value: `> <:edit:1117124140290297896> **Giriş çıkış kanalını ayarlarsın!**`, inline: true  },
		{ name: "**> <:slash:1041998751419605004> </giriş-çıkış-mesaj:1067118408816132207>**", value: `> <:edit:1117124140290297896> **Giriş çıkış mesajını ayarlarsınız!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </kanal-açıklama:1039964202045030426>**", value: `> <:edit:1117124140290297896> **Kanal açıklamasını değiştirirsin!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </kick:1039964202095349880>**", value: `> <:edit:1117124140290297896> **Bir üyeyi atarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </küfür-engel:1039964202095349883>**", value: `> <:edit:1117124140290297896> **Küfür engel sistemini açıp kapatırsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </oto-rol:1039964202095349887> | </oto-rol-kapat:1039964202095349886>**", value: `> <:edit:1117124140290297896> **OtoRol'ü ayarlarsın!!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </oto-tag:1039964202095349889> | </oto-tag-kapat:1039964202095349888>**", value: `> <:edit:1117124140290297896> **OtoTag'ı ayarlarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </oylama:1039964202149879908>**", value: `> <:edit:1117124140290297896> **Oylama başlatırsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </reklam-engel:1039964202149879911>**", value: `> <:edit:1117124140290297896> **Reklam engellemeyi açarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </rol-al:1039964202149879912>**", value: `> <:edit:1117124140290297896> **Rol alırsın!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </timeout-sistemi:1048961342540877907>**", value: `> <:edit:1117124140290297896> **Timeout sistemini ayarlarsın!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </timeout-sistemi-sıfırla:1048961342540877906>**", value: `> <:edit:1117124140290297896> **Timeout sistemini sıfırlarsın!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </timeout:1048961342540877908>**", value: `> <:edit:1117124140290297896> **Belirlenen kullanıcıya timeout atar.**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </untimeout:1048961342540877909>**", value: `> <:edit:1117124140290297896> **Belirlenen kullanıcının timeoutunu kaldırır.**`, inline: true  },
                  )
          .setColor("Random")
      ...
      .setTitle("> <:mod:1039607060775571476> | Aries - Moderasyon 2 Menüsü!")
      .addFields(
        { name: "**> <:slash:1041998751419605004> </rol-oluştur:1039964202149879913>**", value: `> <:edit:1117124140290297896> **Rol oluşturursun!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </rol-ver:1039964202149879914>**", value: `> <:edit:1117124140290297896> **Rol verirsin!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </sa-as:1039964202149879915>**", value: `> <:edit:1117124140290297896> **Selam sistemini ayarlarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </sil:1039964202149879917>**", value: `> <:edit:1117124140290297896> **Mesaj silersin!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </unban:1039964202359603301>**", value: `> <:edit:1117124140290297896> **Bir üyenin yasağını kaldırırsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </buton-rol:1039964202003079246>**", value: `> <:edit:1117124140290297896> **Buton rol sistemini ayarlarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </capslock-koruma:1039964202003079247>**", value: `> <:edit:1117124140290297896> **CapsLock koruma sistemini ayarlarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </görsel-engel:1039964202045030422> | </görsel-engel-kapat:1039964202045030421>**", value: `> <:edit:1117124140290297896> **Görsel engelleme sistemini ayarlarsın!**`, inline: true  },
        { name: "**> <:slash:1041998751419605004> </yavaş-mod:1039964202359603303>**", value: `> <:edit:1117124140290297896> **Yavaş modu ayarlarsın!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </sunucu-kur:1042791957463846972>**", value: `> <:edit:1117124140290297896> **Otomatik sunucu kurar!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </mod-log ayarla:1043079840695324722>**", value: `> <:edit:1117124140290297896> **Moderasyon Logunu ayarlarsın!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </yasaklı-kelime:1046365423945400420> | </yasaklı-kelime-kapat:1046366035315531796>**", value: `> <:edit:1117124140290297896> **Yasaklı Kelimeyi ayarlarsın!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </kanal-aç:1046452705482248272>**", value: `> <:edit:1117124140290297896> **Kanalı mesaj gönderimine açarsın!**`, inline: true  },
      { name: "**> <:slash:1041998751419605004> </kanal-kilitle:1046452705482248273>**", value: `> <:edit:1117124140290297896> **Kanalı mesaj gönderimine kapatırsın!**`, inline: true  },
	  { name: "**> <:slash:1041998751419605004> </resimli-giriş-çıkış:1068595212705878137>**", value: `> <:edit:1117124140290297896> **Resimli giriş çıkış'ı ayarlarsın!**`, inline: true  }
      )
      .setColor("Random")
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:ek:1039607052340834354> | Aries - Kayıt Menüsü!")
          .addFields(
            { name: "**> <:slash:1041998751419605004> </kayıt-sistemi:1063887700786159709>**", value: `> <:edit:1117124140290297896> **Kayıt sistemini ayarlarsın!**`, inline: true },
          { name: "**> <:slash:1041998751419605004> </kayıt-sistemi-kapat:1063887700786159708>**", value: `> <:edit:1117124140290297896> **Kayıt sistemini kapatırsın**`, inline: true },
			  { name: "**> <:slash:1041998751419605004> </kayıt-isim-sıfırla:1063887700786159708>**", value: `> <:edit:1117124140290297896> **Kayıt sistemindeki ismini sıfırlarsın!**`, inline: true }
                  )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [kayıt23, row2]})
        }
      ...
      .setCustomId("kayıt_"+interaction.user.id),
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:member:1039607059357913098> | Aries - Kullanıcı Menüsü!")
          .addFields(
            { name: "**> <:slash:1041998751419605004> </avatar:1039964202003079242>**", value: `> <:edit:1117124140290297896> **Avatarına bakarsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </afk:1039964202003079241>**", value: `> <:edit:1117124140290297896> **Afk olursun!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </emoji-yazı:1039964202003079249>**", value: `> <:edit:1117124140290297896> **Bota emoji ile yazı!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </istatistik:1039964202045030425>**", value: `> <:edit:1117124140290297896> **Bot istatistikleri!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </kurucu-kim:1039964202095349882>**", value: `> <:edit:1117124140290297896> **Sunucunun kurucusunu gösterir!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </ping:1039964202149879909>**", value: `> <:edit:1117124140290297896> **Botun pingini gösterir!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </yardım:1039964202359603302>**", value: `> <:edit:1117124140290297896> **Yardım menüsü!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </davet:1039964202003079248>**", value: `> <:edit:1117124140290297896> **Botun davet linki!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </kullanıcı-bilgi:1039964202095349881>**", value: `> <:edit:1117124140290297896> **Kullanıcı bilgisi!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </random-anime:1039964202149879910>**", value: `> <:edit:1117124140290297896> **Random Anime atar.**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </say:1039964202149879916>**", value: `> <:edit:1117124140290297896> **Sunucuda kaç üye olduğunu gösterir.**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </sunucupp:1069330554278912091>**", value: `> <:edit:1117124140290297896> **Sunucunun avatarına bakarsın!**`, inline: true  },
            { name: "**> <:slash:1041998751419605004> </sunucu-bilgi:1051458065578348546>**", value: `> <:edit:1117124140290297896> **Sunucu bilgilerini gösterir.**`, inline: true  },
          { name: "**> <:slash:1041998751419605004> </ayarlar:1053000987285127249>**", value: `> <:edit:1117124140290297896> **Sunucu ayarlarını gösterir.**`, inline: true  }
                  )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [kayıt23, row2]})
        }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setAuthor({ name: "Aries Sistemler Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("\n\n**<:Link:1106969829795172514> Linkler**\n> <:Bot:1106994122344104067>・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1038372156578480199&permissions=8&scope=bot%20applications.commands)**\n> <:duyuru1:1108419541979119636>・**Botun destek sunucusu: [Tıkla](https://discord.gg/rtTwrAKUaT)**\n> <:Kilit:1106969826808836176>・**Botun gizlilik politikası: [Tıkla](https://github.com/araschain/Aries-Bot-Privacy-Policy)**")
          .setColor('Blue')
        ...
        if (interaction.customId == "korumasystem_"+interaction.user.id) {
          const embed = new Discord.EmbedBuilder()
          .setTitle("> <:koruma:1044325545925672976> | Aries - Koruma Menüsü!")
          .addFields(
            { name: "**> <:slash:1041998751419605004> </hesap-koruma:1069205098888171560>**", value: `> <:edit:1117124140290297896> **Hesap koruma sistemini açarsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </koruma-log:1069205098888171561>**", value: `> <:edit:1117124140290297896> **Koruma logunu ayarlarsın!**`, inline: true }
          )
          .setColor("Random")
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:Bot:1106994122344104067> | Aries - Botlist Menüsü!")
          .addFields(
            { name: "**> <:slash:1041998751419605004> </botlist-ayarla:1039964202003079245>**", value: `> <:edit:1117124140290297896> **Botlist sistemini ayarlarsın!**`, inline: true }
          )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      const embed = new Discord.EmbedBuilder()
      .setTitle("> <:ses:1041739960493019197> | Aries - Özel Oda Menüsü!")
      .addFields(
        { name: "**> <:slash:1041998751419605004> </özel-oda-sistemi:1041738859572105318>**", value: `> <:edit:1117124140290297896> **Özel Oda Sistemini ayarlarsın!**`, inline: true },
        { name: "**> <:slash:1041998751419605004> </özel-oda-sil:1041738859572105317>**", value: `> <:edit:1117124140290297896> **Özel Odanı silersin!**`, inline: true },
        { name: "**> <:slash:1041998751419605004> </özel-oda-kullanıcı-menü:1041738859572105316>**", value: `> <:edit:1117124140290297896> **Özel Odana kullanıcı eklersin!**`, inline: true }
      )
      .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
        ...
        if (interaction.customId == "anasayfa_"+interaction.user.id) {
          const embed = new EmbedBuilder()
          .setAuthor({ name: "Aries Yardım Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("\n\n**<:Link:1106969829795172514> Linkler**\n> <:Bot:1106994122344104067>・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1038372156578480199&permissions=8&scope=bot%20applications.commands)**\n> <:duyuru1:1108419541979119636>・**Botun destek sunucusu: [Tıkla](https://discord.gg/rtTwrAKUaT)**\n> <:Kilit:1106969826808836176>・**Botun gizlilik politikası: [Tıkla](https://github.com/araschain/Aries-Bot-Privacy-Policy)**")
          .setColor('Blue')
          const row = new Discord.ActionRowBuilder()
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:yenilik:1044325577064190033> | Aries - Ticket Menüsü!")
          .addFields(
            { name: "**> <:slash:1041998751419605004> </destek-sistemi:1065718561311567995>**", value: `> <:edit:1117124140290297896> **Destek sistemini ayarlarsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </destek-sistemi-sıfırla:1065718561311567994>**", value: `> <:edit:1117124140290297896> **Destek sistemini sıfırlarsın!.**`, inline: true  }
                  )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | Aries - Level Menüsü!")
          .addFields(
            { name: "**> <:slash:1041998751419605004> </level-sistemi:1053000987285127254>**", value: `> <:edit:1117124140290297896> **Level sistemini açarsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </level-log ayarla:1053000987285127252>**", value: `> <:edit:1117124140290297896> **Level logu ayarlarsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </level:1053000987285127255>**", value: `> <:edit:1117124140290297896> **Levelini görüntülersin!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </level-ekle:1053000987285127251>**", value: `> <:edit:1117124140290297896> **Level eklersin!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </level-kaldır:1053000987285127253>**", value: `> <:edit:1117124140290297896> **Level kaldırırsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </level-arka-plan:1053750137077387334>**", value: `> <:edit:1117124140290297896> **Level arkaplanını ayarlarsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </level-sıralaması:1053000987285127250>**", value: `> <:edit:1117124140290297896> **Level sıralamasını görüntülersin!**`, inline: true }
          )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | Aries - Captcha Menüsü!")
          .addFields(
            { name: "**> <:slash:1041998751419605004> </captcha-sistemi:1064125585166708918>**", value: `> <:edit:1117124140290297896> **Captcha sistemini açarsın!**`, inline: true },
            { name: "**> <:slash:1041998751419605004> </captcha-görüntüle:1064125585166708917>**", value: `> <:edit:1117124140290297896> **Captcha istatistiklerini görüntülersin!**`, inline: true },
			{ name: "**> <:slash:1041998751419605004> </captcha-sistemi-sıfırla:1068963862600220732>**", value: `> <:edit:1117124140290297896> **Captcha sistemini sıfırlarsın!**`, inline: true }
          )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
        ...
        interaction.deferUpdate();
          ...
          if (interaction.customId === "muteonay_"+interaction.user.id) {
            ...
            if (!ucanEssek) return interaction.reply("<:carpi:1117083838590492772> | Üyeyi bulamadım.")
            ucanEssek.roles.add(muterol)
            const embed = new EmbedBuilder()
            .setDescription(`<:tik:1117083842264703016> | Başarılı bir şekilde <@!${kullanıcı}> isimli kişiye mute atıldı.
        `)
          ...
          if (interaction.customId === "mutered_"+interaction.user.id) {
            ...
            const embed = new EmbedBuilder()
            .setDescription(`<:tik:1117083842264703016> | Başarılı bir şekilde mute iptal edildi.
        `)
            interaction.update({embeds: [embed], components: [row, dmb]})
          }
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.channels.create({name: "💬・sohbet", type: ChannelType.GuildText}).then(sohbet => {
                ...
                .setTitle('Aries Bot - İyi günler diler.')
            ...
            if (interaction.customId === "sunucukurred_"+interaction.user.id) {
              interaction.update({content: `<:tik:1117083842264703016> | Başarılı bir şekilde sunucu kurma iptal edildi!`, embeds: [], components: []})
            } 
          ...
          var sonBos = "<:sonbosbar:1095981520998649867>"
            ...
            if (interaction.customId === "botekle_everyone") {
              ...
              .setTitle("<:carpi:1117083838590492772> | Başarısız!")
        ...
        if (interaction.customId === "kapat_"+interaction.user.id) {
          ...
          const embed1 = new Discord.EmbedBuilder()
              .setTitle("<:tik:1117083842264703016> | Başarıyla Sıfırlandı!")
      ...
      .setTitle('Aries - Özel Oda Kullanıcı Ekleme!')
        ...
        if(interaction.customId === "ekle_"+interaction.user.id){
          ...
          if (!odasiz) return interaction.reply({content: "<:carpi:1117083838590492772> | Sana Ait Bir Oda Bulamadım!", ephemeral: true})
          await interaction.showModal(mod);
        }

        const mod2 = new ModalBuilder()
        .setCustomId('eklemenu2')
        .setTitle('Aries - Özel Oda Kullanıcı Çıkarma!')
          ...
          if (interaction.customId === "unban_everyone") {
            ...
            if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<:carpi:1117083838590492772> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
        ...
        if (interaction.customId === "reddet_everyone") {
          ...
          if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<:carpi:1117083838590492772> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
            ...
            if (!interaction.member.roles.cache.has(botlistadmin)) return interaction.reply({ content: "<:carpi:1117083838590492772> | Bu işlemi gerçekleştirmek için <@&" + botlistadmin + "> rolüne sahip olmalısın!", ephemeral: true })
            ...
            const embed = new EmbedBuilder()
                .setTitle("<:carpi:1117083838590492772> | Bot Reddedildi!")
        ...
        const embed = new Discord.EmbedBuilder()
        .setAuthor({ name: "Aries Destek Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
        ...
        .setColor('Blue')
          ...
          if(find) {
            ...
            .setDescription(`<:carpi:1117083838590492772> Zaten bir talebin bulunmakta.`)
        ...
        if(interaction.customId === `ticketClose_everyone`) {
          ...
          .setDescription(`<:tik:1117083842264703016> | Bu destek talebi kapatılmıştır.`)
          .setColor('Green')
...
if(interaction.customId === `benıdogrula_everyone_${interaction.guild.id}${interaction.user.id}`)
      ...
      await interaction.showModal(giriscikismodal);
        ...
        if(interaction.customId === `giriscikismesajsifirla_`+interaction.user.id) {
          ...
          if (!sayacmessage) {
              const date = new EmbedBuilder()
              .setDescription(`<:carpi:1117083838590492772> | Bu sistem zaten kapalı!`)
          ...
          .setColor(0x2F3136)
          .setAuthor({ name: `${interaction.user.tag}`, iconURL: `${interaction.user.displayAvatarURL()} ` })
          .setDescription("<:tik:1117083842264703016> **|** Giriş çıkış mesajı sıfırlandı!")
