...
module.exports =  {
  ...
  if (sebep) {
    ...
    .setDescription(`<:edit:1117124140290297896> | Etiketlediğin kullanıcı **${sebep}** sebebiyle afk modunda!`)
  ...
  message.delete()
  message.channel.send(`<:carpi:1117083838590492772> | Hey <@${message.author.id}>, Bu Sunucuda Küfür Engel Sistemi Aktif! `)
  }
  }
  ...
  if(linkler.some(alo => message.content.toLowerCase().includes(alo))) {
    ...
    if(message.author?.bot) return;
  message.delete()
  message.channel.send(`<:carpi:1117083838590492772> | Hey <@${message.author.id}>, Bu Sunucuda Reklam Engel Sistemi Aktif! `)
  }
  }
