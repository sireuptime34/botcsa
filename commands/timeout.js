...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!data) return interaction.reply({ content: "<:carpi:1117083838590492772> | Dostum **__Timeout Sistemi__** ayarlanmamış.", ephemeral: true })


        let yetkili = data.yetkili
        let kanal = data.log
        let channel = client.channels.cache.get(kanal)
        if (!channel) return interaction.reply({ content: `<:carpi:1117083838590492772> | Dostum **__Timeout Sistemi__** log kanalı bulunamadı.`, ephemeral: true })

        const uyeYetki = new EmbedBuilder()
            .setColor("Red")
            .setDescription(`<:carpi:1117083838590492772> | Bu komutu kullanabilmek için <@&${yetkili}> rolüne sahip olmalısın!`)

        const botYetki = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Bunu yapabilmek için yeterli yetkiye sahip değilim.")

        const uyeBulunamadi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Belirttiğin üyeyi bulamadım.")

        const pozisyon = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Kullanıcının rolü benim rolümden yüksek.")

        const pozisyon2 = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Kullanıcının rolü senin rolünden yüksek.")

        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Sunucu sahibini susturamazsın dostum.")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Kendine neden timeout atmak istersin ki?")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Ben bir botum, beni susturup ne yapacaksın?")

        const gecerliSure = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Susturabilmem için geçerli bir süre girmelisin.")

        const hata = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1117083838590492772> | Komutu kullanırken bir hata oluştu.")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Yellow")
            .setTitle("<:tik:1117083842264703016> | Bir Üye Susturuldu!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1117083842264703016> | ${kullanıcı} adlı kullanıcıya **${süre}** süre boyunca timeout atıldı!`)
