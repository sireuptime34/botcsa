...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const basarili = new Discord.EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik:1117083842264703016> | Başarıyla Ayarlandı!")
            .setDescription("<:tik:1117083842264703016> | Botlist sistemi başarıyla ayarlandı!")
            .setFooter({ text: "Aries" })


            const menu = new Discord.EmbedBuilder()
            .setColor("000000")
            .setTitle("<:edit:1117124140290297896> | Botumu Nasıl Eklerim?")
