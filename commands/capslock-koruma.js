   ...
   switch(capslockSystemTrue) {
    case "ac": {
      ...
      if (capslockSystem && capslockSystemDate) {
          ...
          .setDescription(`<:carpi:1117083838590492772> | Bu sistem <t:${parseInt(capslockSystemDate.date / 1000)}:R> önce açılmış!`)
    ...
    case "kapat": {
      if(!capslockSystem) return interaction.reply({ content: "<:carpi:1117083838590492772> | Bu sistem zaten kapalı?" });
