      ...
      try {
        ...
        if(member.user.bot) {
            if(data) {
                ...
                .setTitle("<:tik:1117083842264703016> | Bot Onaylandı!")
            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba Aries kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
