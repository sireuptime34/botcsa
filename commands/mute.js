...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!interaction.member.roles.cache.has(db.fetch(`yetkili_${interaction.guild.id}`))) return interaction.reply(`<:carpi:1117083838590492772> | Bu komutu sadece ayarlanan **Mute Yetkilisi** rolü olan kişiler kullanabilir.`)
