...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (kayitSistemi && kayıtSistemiDate) {
            ...
            .setDescription(`<:carpi:1117083838590492772> | Bu sistem <t:${parseInt(kayıtSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1117083842264703016> | __**Kayıt Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Kayıt Kanalı: ${kayıtkanal}\n<:Bot:1106994122344104067> Kayıtlı Rolü: ${kayıtlırol}\n<:Bot:1106994122344104067> Kayıtsız Rolü: ${kayıtsızrol}`)
